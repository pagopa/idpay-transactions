...
class MerchantTransactionServiceImplTest {
    ...
    void getMerchantTransactionList() {
        ...
        Mockito.when(rewardTransactionRepository.getCount(MERCHANT_ID, INITIATIVE_ID, null, USER_ID, null)).thenReturn(Mono.just(1L));
    ...
    void getMerchantTransactionListNoFiscalCode() {
        ...
        Mockito.when(rewardTransactionRepository.getCount(MERCHANT_ID, INITIATIVE_ID, null, null, null)).thenReturn(Mono.just(1L));
