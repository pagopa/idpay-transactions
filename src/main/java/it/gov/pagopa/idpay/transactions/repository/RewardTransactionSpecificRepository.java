...
public interface RewardTransactionSpecificRepository {
    ...
    Mono<Long> getCount(String merchantId, String initiativeId, String pointOfSaleId, String userId, String status);
    ...
    Flux<RewardTransaction> findByFilterTrx(String merchantId, String initiativeId, String pointOfSaleId, String userId, String status, Pageable pageable);
}
