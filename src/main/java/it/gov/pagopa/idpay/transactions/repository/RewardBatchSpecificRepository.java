...
public interface RewardBatchSpecificRepository {
  ...
  Flux<RewardBatch> findRewardBatchesCombined(String merchantId, String status, String assigneeLevel, String month, String merchantIdFilter, boolean isOperator, Pageable pageable);
  Mono<Long> getCountCombined(String merchantId, String status, String assigneeLevel, String month, String merchantIdFilter, boolean isOperator);
